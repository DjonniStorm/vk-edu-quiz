...
import type { LeaderboardItem, LiveQuestion, RoomParticipantDetails } from "../rooms/rooms.interfaces";
...
export type RealtimeEvent =
  ...
  | { type: RealtimeEventType.AnswerSubmitted; roomId: EntityId; answeredCount: number }
