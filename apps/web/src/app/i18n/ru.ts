...
export const ru: Translation = {
  ...
  pages: {
    ...
    error: {
      ...
      subtitle: "Произошла непредвиденная ошибка. Попробуйте ещё раз или вернитесь на главную.",
      backToMain: "На главную",
      notFound: "Страница не найдена",
    },
    organizerDashboard: {
      title: "Панель организатора",
      metaDescription: "Управление квизами, статистика и вход в комнаты для организаторов",
      ...
      joinRoom: {
        ...
        subtitle: "Вставьте ссылку-приглашение или ID комнаты от организатора",
        identity: "Вы: {{name}} · {{email}}",
        inputLabel: "Ссылка или ID комнаты",
        inputPlaceholder: "Ссылка, UUID или код комнаты",
        join: "Присоединиться",
        invalidInput: "Укажите корректную ссылку или ID комнаты",
        notFound: "Комната не найдена",
        closed: "Комната уже завершена",
        failed: "Не удалось присоединиться к комнате",
      },
      stats: {
        totalQuizzes: {
          label: "Всего квизов",
    ...
    room: {
      ...
      host: {
        metaTitle: "Ведущий квиза",
        titleWithQuiz: "{{title}} — ведущий",
        live: "В ЭФИРЕ",
